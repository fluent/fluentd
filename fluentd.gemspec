...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{Sadayuki Furuhashi}]
  s.date = %q{2011-11-18}
  s.email = %q{frsyuki@gmail.com}
  s.executables = [%q{fluentd}, %q{fluent-cat}, %q{fluent-gem}]
  s.extra_rdoc_files = [
    "ChangeLog",
    "README",
    "README.rdoc"
  ...
  s.test_files = [%q{test/config.rb}, %q{test/helper.rb}, %q{test/match.rb}, %q{test/plugin/in_exec.rb}, %q{test/plugin/in_forward.rb}, %q{test/plugin/in_http.rb}, %q{test/plugin/in_stream.rb}, %q{test/plugin/out_copy.rb}, %q{test/plugin/out_exec.rb}, %q{test/plugin/out_exec_filter.rb}, %q{test/plugin/out_file.rb}, %q{test/plugin/out_forward.rb}, %q{test/plugin/out_roundrobin.rb}, %q{test/plugin/out_stream.rb}]
