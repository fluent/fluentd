  ...
  class FileOutput < Output
    ...
    def configure(conf)
      ...
      if @symlink_path && @buffer.respond_to?(:path)
        ...
        unless @buffer.compress == :text
          if @compress == :text
            log.info "buffer is compressed.  If you also want to save disk space, Add `compress` configuration in <match>"
          elsif @buffer.compress != @compress_method
