...
module Fluentd
...

  {
    ...
    :Chunk => 'fluentd/chunk',
    :MessagePackChunk => 'fluentd/chunk',
    :Collector => 'fluentd/collector',
    :FilteredCollector => 'fluentd/filtered_collector',
    :Config => 'fluentd/config',
    :ConfigError => 'fluentd/config',
    :ConfigParseError => 'fluentd/config',
    :MatchPattern => 'fluentd/match_pattern',
    :AllMatchPattern => 'fluentd/match_pattern',
    :GlobMatchPattern => 'fluentd/match_pattern',
