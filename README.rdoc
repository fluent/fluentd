...
=== Setting environment
Set RUBY_INSTALL_DIR in env.rb at first after install fluentd. It is requried when using on Windows. env.rb is typically at C:/Ruby193/lib/ruby/gems/1.9.1/gems/fluentd-0.10.42/lib/fluent.
*name*:: *example*
