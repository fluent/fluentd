...
Fluentd is an event collector system. Fluentd is generalized version of syslogd, which deals with JSON object for the log message.

== Architecture

Fluentd collects events from various data sources and write them to files, database or other storages:
