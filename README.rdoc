...
You can use a local gem, pkg/fluentd-0.10.35.gem included.

    gem install pkg/fluentd-0.10.35.gem

== General condition

=== Setting environment
Set RUBY_INSTALL_DIR in env.rb at first after install fluentd. It is requried when using on Windows. env.rb is typically at C:/Ruby193/lib/ruby/gems/1.9.1/gems/fluentd-0.10.35/lib/fluent.
*name*:: *example*
...
in_exec:: Not work correctly at times.
...
out_file:: Looks good.
out_exec:: Not work correctly yet at times.
out_exec_filter:: Unknown.
out_roundrobin:: Unknown.
